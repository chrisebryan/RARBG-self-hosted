...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            $searchQuery = "SELECT * FROM items WHERE cat = 'xxx' ORDER BY dt DESC LIMIT " . $itemsPerPage . " OFFSET " . $offset;
            ...
            $searchCountQuery = "SELECT COUNT(*) as total FROM items WHERE cat = 'xxx' AND title LIKE '%" . $searchTerm . "%'";
