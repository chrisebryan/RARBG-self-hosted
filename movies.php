...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            $searchQuery = "SELECT * FROM items WHERE cat IN ('movies', 'movies_bd_full', 'movies_bd_remux', 'movies_x264', 'movies_x264_720', 'movies_x264_3d', 'movies_x264_4k', 'movies_x265_4k', 'movies_x265', 'movies_x265_4k', 'movies_x265_4k_hdr', 'movies_xvid', 'movies_xvid_720') ORDER BY dt DESC LIMIT " . $itemsPerPage . " OFFSET " . $offset;
            ...
            $searchCountQuery = "SELECT COUNT(*) as total FROM items WHERE cat IN ('movies', 'movies_bd_full', 'movies_bd_remux', 'movies_x264', 'movies_x264_720', 'movies_x264_3d', 'movies_x264_4k', 'movies_x265_4k', 'movies_x265', 'movies_x265_4k', 'movies_x265_4k_hdr', 'movies_xvid', 'movies_xvid_720') AND title LIKE '%" . $searchTerm . "%'";
