...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            $searchQuery = "SELECT * FROM items WHERE cat = 'music_flac' ORDER BY dt DESC LIMIT " . $itemsPerPage . " OFFSET " . $offset;
            ...
            $searchCountQuery = "SELECT COUNT(*) as total FROM items WHERE cat = 'music_flac' AND title LIKE '%" . $searchTerm . "%'";
