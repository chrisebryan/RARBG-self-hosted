...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            $searchQuery = "SELECT * FROM items WHERE cat = 'ebooks' ORDER BY dt DESC LIMIT " . $itemsPerPage . " OFFSET " . $offset;
            ...
            $searchCountQuery = "SELECT COUNT(*) as total FROM items WHERE cat = 'ebooks' AND title LIKE '%" . $searchTerm . "%'";
