...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            $searchQuery = "SELECT * FROM items WHERE cat IN ('tv', 'tv_sd', 'tv_uhd') ORDER BY dt DESC LIMIT " . $itemsPerPage . " OFFSET " . $offset;
            ...
            $searchCountQuery = "SELECT COUNT(*) as total FROM items WHERE cat IN ('tv', 'tv_sd', 'tv_uhd') AND title LIKE '%" . $searchTerm . "%'";
